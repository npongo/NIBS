...
#%%
dist_max_t_farm_size_sql_ipcc = """
select *
from vwM_district_max_n2o_farm_size_summary_ipcc_2019
"""
dist_max_t_farm_size_df_ipcc = load_map_data(db_client_input, dist_max_t_farm_size_sql_ipcc)

dist_max_t_farm_size_df_ipcc['max_fert_induced_Tg_n2o_n_farm_size'] = dist_max_t_farm_size_df_ipcc['max_fert_induced_Tg_n2o_n_farm_size'].replace(farm_size_replacements)
dist_max_t_farm_size_df_ipcc['max_fert_induced_kg_n2o_n_ha_farm_size'] = dist_max_t_farm_size_df_ipcc['max_fert_induced_kg_n2o_n_ha_farm_size'].replace(farm_size_replacements)

dist_max_t_farm_size_df_ipcc['max_fert_induced_Tg_n2o_n_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_ipcc['max_fert_induced_Tg_n2o_n_farm_size']
                                    , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)
             
dist_max_t_farm_size_df_ipcc['max_fert_induced_kg_n2o_n_ha_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_ipcc['max_fert_induced_kg_n2o_n_ha_farm_size']
                                              , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)

dist_max_t_farm_size_df_ipcc.head()

#%% 
d_max_t_ipcc_2019 = (ggplot(dist_max_t_farm_size_df_ipcc)
...
d_max_t_ipcc_2019.save(filename="map_district_n2o_farm_size_max_t_ipcc_2019.png", path=chart_dir,  units='cm', dpi=300)
d_max_t_ipcc_2019

#%% 
d_max_ha_ipcc_2019 = (ggplot(dist_max_t_farm_size_df_ipcc)
    + geom_map(india, fill='grey', color=None, show_legend=False)
     #+ scale_fill_brewer(type='div', palette=8)
     + scale_x_continuous(limits=(67.5,97.5))
     + scale_y_continuous(limits=(7.5,37.5))
    ...
    + geom_map(aes(fill="max_fert_induced_kg_n2o_n_ha_farm_size"), color=None, show_legend=True)
    + geom_map(india_states, color="white", fill=None, size=.25, show_legend=False)
            + labs(title='All crops, Landholding size\nwith largest $N_2O$ emissions perhectare\n(IPCC 2019 Updated Methodology)')
...
d_max_ha_ipcc_2019.save(filename="map_district_n2o_farm_size_max_ha_ipcc_2019.png", path=chart_dir,  units='cm', dpi=300)
d_max_ha_ipcc_2019

#%%
dist_max_t_farm_size_sql_bhatia = """
select *
from vwM_district_max_n2o_farm_size_summary_bhatia_2013
"""
dist_max_t_farm_size_df_bhatia = load_map_data(db_client_input, dist_max_t_farm_size_sql_bhatia)

dist_max_t_farm_size_df_bhatia['max_fert_induced_Tg_n2o_n_farm_size'] = dist_max_t_farm_size_df_bhatia['max_fert_induced_Tg_n2o_n_farm_size'].replace(farm_size_replacements)
dist_max_t_farm_size_df_bhatia['max_fert_induced_kg_n2o_n_ha_farm_size'] = dist_max_t_farm_size_df_bhatia['max_fert_induced_kg_n2o_n_ha_farm_size'].replace(farm_size_replacements)

dist_max_t_farm_size_df_bhatia['max_fert_induced_Tg_n2o_n_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_bhatia['max_fert_induced_Tg_n2o_n_farm_size']
                                    , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)
             
dist_max_t_farm_size_df_bhatia['max_fert_induced_kg_n2o_n_ha_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_bhatia['max_fert_induced_kg_n2o_n_ha_farm_size']
                                              , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)
...
d_max_t_bhatia_2013.save(filename="map_district_n2o_farm_size_max_t_bhatia_2013.png", path=chart_dir,  units='cm', dpi=300)
d_max_t_bhatia_2013
...
d_max_ha_bhatia_2013 = (ggplot(dist_max_t_farm_size_df_bhatia)
    ...
    + geom_map(aes(fill="max_fert_induced_kg_n2o_n_ha_farm_size"), color=None, show_legend=True)
    + geom_map(india_states, color="white", fill=None, size=.25, show_legend=False)
            + labs(title='All crops, Landholding size\nwith largest $N_2O$ emissions per\nhectare(Bhatia et al., 2013)')
...
d_max_ha_bhatia_2013.save(filename="map_district_n2o_farm_size_max_ha_bhatia_2013.png", path=chart_dir,  units='cm', dpi=300)
d_max_ha_bhatia_2013


#%%
dist_max_t_farm_size_sql_eagle = """
select *
from vwM_district_max_n2o_farm_size_summary_eagle_2020
"""
dist_max_t_farm_size_df_eagle = load_map_data(db_client_input, dist_max_t_farm_size_sql_eagle)

dist_max_t_farm_size_df_eagle['max_fert_induced_Tg_n2o_n_farm_size'] = dist_max_t_farm_size_df_eagle['max_fert_induced_Tg_n2o_n_farm_size'].replace(farm_size_replacements)
dist_max_t_farm_size_df_eagle['max_fert_induced_kg_n2o_n_ha_farm_size'] = dist_max_t_farm_size_df_eagle['max_fert_induced_kg_n2o_n_ha_farm_size'].replace(farm_size_replacements)

dist_max_t_farm_size_df_eagle['max_fert_induced_Tg_n2o_n_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_eagle['max_fert_induced_Tg_n2o_n_farm_size']
                                    , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)
             
dist_max_t_farm_size_df_eagle['max_fert_induced_kg_n2o_n_ha_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_eagle['max_fert_induced_kg_n2o_n_ha_farm_size']
                                              , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)

dist_max_t_farm_size_df_eagle.head()

#%% 
d_max_t_eagle_2020 = (ggplot(dist_max_t_farm_size_df_eagle)
    + geom_map(india, fill='grey', color=None, show_legend=False)
     #+ scale_fill_brewer(type='div', palette=8)
     + scale_x_continuous(limits=(67.5,97.5))
     + scale_y_continuous(limits=(7.5,37.5))
...
d_max_t_eagle_2020.save(filename="map_district_n2o_farm_size_max_t_eagle_2020.png", path=chart_dir,  units='cm', dpi=300)
d_max_t_eagle_2020

#%% 
d_max_ha_eagle_2020 = (ggplot(dist_max_t_farm_size_df_eagle)
    + geom_map(india, fill='grey', color=None, show_legend=False)
     #+ scale_fill_brewer(type='div', palette=8)
     + scale_x_continuous(limits=(67.5,97.5))
     + scale_y_continuous(limits=(7.5,37.5))
...
d_max_ha_eagle_2020.save(filename="map_district_n2o_farm_size_max_ha_eagle_2020.png", path=chart_dir,  units='cm', dpi=300)
d_max_ha_eagle_2020


#%%
dist_max_t_farm_size_sql_shcherbak = """
select *
from vwM_district_max_n2o_farm_size_summary_shcherbak_2014
"""
dist_max_t_farm_size_df_shcherbak = load_map_data(db_client_input, dist_max_t_farm_size_sql_shcherbak)

dist_max_t_farm_size_df_shcherbak['max_fert_induced_Tg_n2o_n_farm_size'] = dist_max_t_farm_size_df_shcherbak['max_fert_induced_Tg_n2o_n_farm_size'].replace(farm_size_replacements)
dist_max_t_farm_size_df_shcherbak['max_fert_induced_kg_n2o_n_ha_farm_size'] = dist_max_t_farm_size_df_shcherbak['max_fert_induced_kg_n2o_n_ha_farm_size'].replace(farm_size_replacements)

dist_max_t_farm_size_df_shcherbak['max_fert_induced_Tg_n2o_n_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_shcherbak['max_fert_induced_Tg_n2o_n_farm_size']
                                    , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)
             
dist_max_t_farm_size_df_shcherbak['max_fert_induced_kg_n2o_n_ha_farm_size'] = pd.Categorical(dist_max_t_farm_size_df_shcherbak['max_fert_induced_kg_n2o_n_ha_farm_size']
                                              , categories=[ '<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha','≥10 Ha' ], ordered=True)

dist_max_t_farm_size_df_shcherbak.head()

#%% 
d_max_t_shcherbak_2014 = (ggplot(dist_max_t_farm_size_df_shcherbak)
    + geom_map(india, fill='grey', color=None, show_legend=False)
     #+ scale_fill_brewer(type='div', palette=8)
     + scale_x_continuous(limits=(67.5,97.5))
     + scale_y_continuous(limits=(7.5,37.5))
...
d_max_t_shcherbak_2014.save(filename="map_district_n2o_farm_size_max_t_shcherbak_2014.png", path=chart_dir,  units='cm', dpi=300)
d_max_t_shcherbak_2014

#%% 
d_max_ha_shcherbak_2014 = (ggplot(dist_max_t_farm_size_df_shcherbak)
    + geom_map(india, fill='grey', color=None, show_legend=False)
     #+ scale_fill_brewer(type='div', palette=8)
     + scale_x_continuous(limits=(67.5,97.5))
     + scale_y_continuous(limits=(7.5,37.5))
...
d_max_ha_shcherbak_2014.save(filename="map_district_n2o_farm_size_max_ha_shcherbak_2014.png", path=chart_dir,  units='cm', dpi=300)
...
categorical_ha_columns = list(rename_dict.keys())[:4] # ['max_kg_n2o_ha_farm_size_bhatia_2013', 'max_kg_n2o_ha_farm_size_eagle_2020', 'max_kg_n2o_ha_farm_size_ipcc_2019', 'max_kg_n2o_ha_farm_size_shcherbak_2014']  
categorical_columns = list(rename_dict.keys())[4:] # ['max_kg_n2o_ha_farm_size_bhatia_2013', 'max_kg_n2o_ha_farm_size_eagle_2020', 'max_kg_n2o_ha_farm_size_ipcc_2019', 'max_kg_n2o_ha_farm_size_shcherbak_2014']  

# %%
from scipy.stats import chi2_contingency

cramer_v_sql = """select * from vwM_district_max_n2o_farm_size_summary_all_models"""
...
heatmap_plot = (
    ...
    labs(title='District farm size with highest $N_2O$ emission\n($Kg\ N_2O\ Ha^{-1}$ Cramér\'s V)', x='', y='') +
...
print(heatmap_plot)
# Save the heatmap
heatmap_plot.save(os.path.join(chart_dir, "farm_size_kg_ha_cramers_v_heatmap.png"), dpi=300)
...
print(heatmap_plot)
# Save the heatmap
heatmap_plot.save(os.path.join(chart_dir, "farm_size_t_n2o_cramers_v_heatmap.png"), dpi=300)


# %%
fert_farm_size_sql = """select *
from [dbo].[vwG_inorganic_organic_fert_by_farm_size]
"""
fert_farm_size_df = load_table_data(db_client_input, fert_farm_size_sql)
fert_farm_size_df['fert_type'] = fert_farm_size_df['fert_type'].replace({'inorganic': 'Inorganic', 'organic': 'Organic'})
fert_farm_size_df['farm_size'] = pd.Categorical(fert_farm_size_df['farm_size'], categories=['<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha', '≥10 Ha'], ordered=True)
...
print(g)
g.save(os.path.join(chart_dir, " fert_type_by_farm_size.png"), dpi=300)


# %%
fert_farm_size_sql = """select *
from [dbo].[vwG_rice_inorganic_organic_fert_by_farm_size]
"""
fert_farm_size_df = load_table_data(db_client_input, fert_farm_size_sql)
fert_farm_size_df['fert_type'] = fert_farm_size_df['fert_type'].replace({'inorganic': 'Inorganic', 'organic': 'Organic'})
fert_farm_size_df['farm_size'] = pd.Categorical(fert_farm_size_df['farm_size'], categories=['<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha', '≥10 Ha'], ordered=True)
...
print(g)
g.save(os.path.join(chart_dir, "rice_fert_type_by_farm_size.png"), dpi=300)

# %%
fert_farm_size_sql = """select *
from [dbo].[vwG_upland_crop_inorganic_organic_fert_by_farm_size]
"""
fert_farm_size_df = load_table_data(db_client_input, fert_farm_size_sql)
fert_farm_size_df['fert_type'] = fert_farm_size_df['fert_type'].replace({'inorganic': 'Inorganic', 'organic': 'Organic'})
fert_farm_size_df['farm_size'] = pd.Categorical(fert_farm_size_df['farm_size'], categories=['<2.0 Ha', '2.0 - 3.99 Ha', '4.0 - 9.99 Ha', '≥10 Ha'], ordered=True)
...
print(g)
g.save(os.path.join(chart_dir, "none_rice_crop_fert_type_by_farm_size.png"), dpi=300)
